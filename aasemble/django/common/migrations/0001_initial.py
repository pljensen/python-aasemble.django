...
def add_initial_features(apps, schema_editor):
    ...
    Feature.objects.create(name='DUMMY_FEATURE', on_by_default=True, description='Dummy feature. On by default.')
    Feature.objects.create(name='DUMMY_FEATURE_2', on_by_default=False, description='Dummy feature. Off by default.')
